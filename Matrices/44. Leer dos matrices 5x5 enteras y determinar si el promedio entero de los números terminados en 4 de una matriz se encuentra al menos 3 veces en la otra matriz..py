...
if filas<=0 or columnas<=0:
    ...
    if cont_2>0:
        ...
        print(f"No existe ningun numero terminado en 4 en la SEGUNDA MATRIZ")
    ...
    if comprobante==True:     # La funcion clave del comprobante es habilitar o inhabilitar esta opcion, dependiendo si existen numeros terminados en 4 o no
        ...
        if cont_1>=3:
            ...
            print(f"el promedio de los numeros terminados en 4 de la PRIMERA MATRIZ es igual a {promedio_1} y no se encuentra en la SEGUNDA MATRIZ")
    ...
    if comprobante_2==True: # lo mismo sucede aca
        ...
        if cont_2>=3:
            ...
            print(f"el promedio de los numeros terminados en 4 de la SEGUNDA MATRIZ es igual a {promedio_2} y no se encuentra en la PRIMERA MATRIZ")
