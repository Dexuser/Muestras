...
if filas<=0 or columnas<=0:
    ...
    for f2 in range(filas):
        for c2 in range(columnas):
            ...
            if m2[f2][c2]==mayor_prim1:
                comprobante+=1
    
    if comprobante>0:
        print(f"el mayor numero primo de la PRIMERA MATRIZ es {mayor_prim1} y se encuentra tambien en la SEGUNDA MATRIZ")
            
    else:
        print("El mayor numero primo de la PRIMERA MATRIZ NO se encuentra en la SEGUNDA MATRIZ")
    ...
    for f2 in range(filas):
        ...
        for f1 in range(filas):
            for c1 in range(columnas):
                ...
                if m1[f1][c1]==mayor_prim2:
                    comprobante2+=1
    
    if comprobante2>0:
        print(f"el mayor numero primo de la SEGUNDA MATRIZ es {mayor_prim2} y se encuentra tambien en la PRIMERA MATRIZ")
            
    else:
        print("El mayor numero primo de la SEGUNDA MATRIZ NO se encuentra en la PRIMERA MATRIZ")
