...
class Aplicacion:
    def __init__(self):
        ...
        self.boton5.pack(side=tk.LEFT)
        self.boton6=ttk.Button(self.ventana1, text="Boton6")
        self.boton6.pack(side=tk.RIGHT)
        self.boton7=ttk.Button(self.ventana1, text="Boton7")
        self.boton7.pack(side=tk.RIGHT)
        self.boton8=ttk.Button(self.ventana1, text="Boton8")
        self.boton8.pack(side=tk.BOTTOM)
